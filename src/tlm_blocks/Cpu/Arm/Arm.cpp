...
uint32_t
Arm::rd_l_cb(void *obj, uint32_t addr)
{
    struct Arm* myself = (struct Arm*)obj;
    return myself->rd_l(addr);
}

uint32_t
Arm::rd_s_cb(void *obj, uint32_t addr)
{
    struct Arm* myself = (struct Arm*)obj;
...
uint32_t
Arm::rd_b_cb(void *obj, uint32_t addr)
{
    struct Arm* myself = (struct Arm*)obj;
...
void
Arm::wr_l_cb(void *obj, uint32_t addr, uint32_t data)
{
    struct Arm* myself = (struct Arm*)obj;
...
void
Arm::wr_s_cb(void *obj, uint32_t addr, uint32_t data)
{
    struct Arm* myself = (struct Arm*)obj;
...
void
Arm::wr_b_cb(void *obj, uint32_t addr, uint32_t data)
{
    struct Arm* myself = (struct Arm*)obj;
...
int
Arm::gdb_rd_cb(void *obj, uint64_t addr, uint8_t* dataptr, uint32_t len)
{
    struct Arm* myself = (struct Arm*)obj;
...
int
Arm::gdb_wr_cb(void *obj, uint64_t addr, uint8_t* dataptr, uint32_t len)
{
    struct Arm* myself = (struct Arm*)obj;
