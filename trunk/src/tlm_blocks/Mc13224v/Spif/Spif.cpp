...
Spif::Spif(sc_core::sc_module_name name, uint8_t* flashdata, uint32_t flashsize)
...
, m_free(true)
{
    ...
    reg_s_socket.register_b_transport(this, &Spif::reg_s_b_transport);
    reg_s_socket.register_nb_transport_fw(this, &Spif::reg_s_nb_transport_fw);
    reg_s_socket.register_transport_dbg(this, &Spif::reg_s_transport_dbg);
...
void Spif::reg_s_b_transport( tlm::tlm_generic_payload& trans, sc_core::sc_time& delay )
{
...
tlm::tlm_sync_enum Spif::reg_s_nb_transport_fw( tlm::tlm_generic_payload& trans,
...
unsigned int Spif::reg_s_transport_dbg(tlm::tlm_generic_payload& trans)
{
    // sanity check
...
uint32_t Spif::reg_rd(uint32_t offset)
{
    uint32_t result;
    // retrieve the required parameters
...
void Spif::reg_wr(uint32_t offset, uint32_t value)
{
    // retrieve the required parameters
    uint32_t index = offset/4;
