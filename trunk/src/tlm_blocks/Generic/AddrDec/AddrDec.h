...
//        SC_THREAD(thread_process);
     ...
     * @param start Decoding start address (inclusive).
     * @param end Decoding end address (exclusive, first address not to be decoded).
